...
// import 'Electrical_detailScreen.dart';
//
//
//
// class ElectricalListScr extends StatefulWidget {
//   @override
//   _ListScreenState createState() => _ListScreenState();
// }
//
// class _ListScreenState extends State<ElectricalListScr> {
//   final FirebaseFirestore fs = FirebaseFirestore.instance;
//   String _sortOrder = 'latest'; // Default sort order
//
//   Future<List<QueryDocumentSnapshot>> getData() async {
//     try {
//       // Fetch complaints where complaintCategories array contains 'Electrical'
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Electrical Complaints List'),
...
//               return Text('No Electrical complaints found');
//             }
//
...
//               return Text('No Electrical complaints found with valid data');
//             }
//
...
// class ElectricalListScr extends StatefulWidget {
//   @override
//   _ElectricalListScrState createState() => _ElectricalListScrState();
// }
//
// class _ElectricalListScrState extends State<ElectricalListScr> {
//   final FirebaseFirestore fs = FirebaseFirestore.instance;
//   String _sortOrder = 'latest'; // Default sort order
...
//                   data['complaintCategories'].contains('Electrical');
//             }).toList();
//
//             if (filteredData.isEmpty) {
//               return Text('No Electrical complaints found with valid data');
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => ElectricalDetailScreen(
//                           imageUrls: imageUrls,
//                           description: description,
//                           status: status,
//                           priority: priority,
...
class _ElectricalListScrState extends State<ElectricalListScr> {
  ...
  Future<List<QueryDocumentSnapshot>> getData() async {
    try {
      Query query = fs
          .collection('complaints')
          .where('categories', arrayContains: 'Electrical')
          .orderBy('timestamp', descending: _sortOrder == 'latest');
      ...
      body: LiquidPullToRefresh(
        ...
        child: FutureBuilder<List<QueryDocumentSnapshot>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.isEmpty) {
              return Center(child: Text('No electrical complaints found'));
            }
            ...
            final filteredData = snapshot.data!.where((doc) {
              ...
              return data != null &&
                  ...
                  data['categories'].contains('Electrical');
            }).toList();

            if (filteredData.isEmpty) {
              return Center(child: Text('No electrical complaints found with valid data'));
            }
