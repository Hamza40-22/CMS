...
//  new accept and complete all details working
// status isn't there for all
//
// import 'dart:io';
// import 'package:dio/dio.dart';
// import 'package:flutter/material.dart';
...
//     if (dateTime == null) return 'N/A';
//
//     // Use DateFormat to include AM/PM format
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          // Fetching utilityStatus, mechanicalStatus, electricalStatus, hvacStatus
          final utilityStatus = complaintData['utilityStatus'] ?? 'N/A';
          final mechanicalStatus = complaintData['mechanicalStatus'] ?? 'N/A';
          final electricalStatus = complaintData['electricalStatus'] ?? 'N/A';
          final hvacStatus = complaintData['hvacStatus'] ?? 'N/A';
          final timestamp = (complaintData['timestamp'] as Timestamp?)?.toDate();
            ...
            child: Column(
              ...
              children: [
                if (imageUrls.isNotEmpty || videoUrls.isNotEmpty)
                  _buildMediaSlider(imageUrls, videoUrls),
                SizedBox(height: 16),
                // Add the new field "Complaint Generated At"
                _buildGlassContainer(
                  child: _buildInfoBox('Complaint Generated At', _formatDateTime(timestamp)),
                ),
                SizedBox(height: 16),
                ...
                // Displaying the additional statuses
                _buildGlassContainer(
                  child: _buildInfoBox('Utility Status', utilityStatus),
                ),
                SizedBox(height: 16),
                _buildGlassContainer(
                  child: _buildInfoBox('Mechanical Status', mechanicalStatus),
                ),
                SizedBox(height: 16),
                _buildGlassContainer(
                  child: _buildInfoBox('Electrical Status', electricalStatus),
                ),
                SizedBox(height: 16),
                _buildGlassContainer(
                  child: _buildInfoBox('HVAC Status', hvacStatus),
                ),
                SizedBox(height: 16),
